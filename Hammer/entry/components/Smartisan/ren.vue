<template>
	<div>
		<div id="Sma-ren-one">
			<img src="../../czimg/ren-1.jpg" />
		</div>
		<div id="Sma-ren-two">
			<img src="../../czimg/ren-2.jpg" />
		</div>
		<div id="Sma-ren-three">
			<img src="../../czimg/ren-3.jpg" />
		</div>
		<div id="Sma-ren-four">
			<img src="../../czimg/ren-4.jpg" />
		</div>
		<div id="Sma-ren-five">
			<img src="../../czimg/ren-5.jpg" />
		</div>
		<div id="Sma-ren-six">
			<img src="../../czimg/ren-6.jpg" />
		</div>
		<div id="Sma-ren-seven">
			<img src="../../czimg/ren-7.jpg" />
		</div>
		<div id="Sma-ren-eight">
			<img src="../../czimg/ren-8.jpg" />
		</div>
		<div id="Sma-ren-night">
			<img src="../../czimg/ren-9.jpg" />
		</div>
		<div id="Sma-ren-slide">
...
<style scoped>
	...
	#Sma-ren-slide .haode:nth-child(1) {
	...
	#Sma-ren-footer .Sma-ren-one {
		margin-top: 0.15rem;
	}
	
	#Sma-ren-footer .Sma-ren-one h6 {
		float: left;
		padding: 0 0.1rem 0 0.6rem;
	}
	
	#Sma-ren-footer .Sma-ren-one ul li {
		float: left;
		padding: 0 0.1rem;
		border-left: 1px solid #ccc;
	}
	
	#Sma-ren-footer .Sma-ren-one ul li a {
		color: #0000FF;
	}
	
	#Sma-ren-footer .Sma-ren-two {
		text-align: center;
		padding-top: 0.08rem;
	}
</style>