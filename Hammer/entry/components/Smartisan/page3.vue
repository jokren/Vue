<template>
	<div>
		<div id="Sma-page3-one">
			<img src="../../czimg/os-6.png" />
		</div>
		<div id="Sma-page3-two">
			<img src="../../czimg/os-7.png" />
		</div>
		<div id="Sma-page3-three">
			<img src="../../czimg/os-8.png" />
		</div>
		<div id="Sma-page3-four">
			<img src="../../czimg/os-9.png" />
		</div>

	
		<div id="Sma-page3-slide">
...
<style scoped>
	...
	#Sma-page3-slide .haode:nth-child(1) {
		border-top: 1px solid #e8e4e4;
	}
	
	#Sma-page3-slide .haode {
		padding-left: 0.3rem;
	...
	#Sma-page3-footer .Sma-page3-one {
		margin-top: 0.15rem;
	}
	
	#Sma-page3-footer .Sma-page3-one h6 {
		float: left;
		padding: 0 0.1rem 0 0.6rem;
	}
	
	#Sma-page3-footer .Sma-page3-one ul li {
		float: left;
		padding: 0 0.1rem;
		border-left: 1px solid #ccc;
	}
	
	#Sma-page3-footer .Sma-page3-one ul li a {
		color: #0000FF;
	}
	
	#Sma-page3-footer .Sma-page3-two {
		text-align: center;
		padding-top: 0.08rem;
	}
</style>