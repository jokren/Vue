<template>
	<div>
		<div id="Sma-yun-one">
			<img src="../../czimg/yun-1.jpg" />
		</div>
		<div id="Sma-yun-two">
			<img src="../../czimg/yun-2.jpg" />
		</div>
		<div id="Sma-yun-three">
			<img src="../../czimg/yun-3.jpg" />
		</div>
		<div id="Sma-yun-four">
			<img src="../../czimg/yun-4.jpg" />
		</div>
		<div id="Sma-yun-five">
			<img src="../../czimg/yun-5.jpg" />
		</div>
		<div id="Sma-yun-six">
			<img src="../../czimg/yun-6.jpg" />
		</div>
		<div id="Sma-yun-seven">
			<img src="../../czimg/yun-7.jpg" />
		</div>
		<div id="Sma-yun-eight">
			<img src="../../czimg/yun-8.jpg" />
		</div>
		<div id="Sma-yun-night">
			<img src="../../czimg/yun-9.jpg" />
		</div>
		<div id="Sma-yun-ten">
			<img src="../../czimg/yun-10.jpg" />
		</div>
		
		<div id="Sma-yun-slide">
...
<style scoped>
	...
	#Sma-yun-slide .haode:nth-child(1) {
	...
	#Sma-yun-footer .Sma-yun-one {
		margin-top: 0.15rem;
	}
	
	#Sma-yun-footer .Sma-yun-one h6 {
		float: left;
		padding: 0 0.1rem 0 0.6rem;
	}
	
	#Sma-yun-footer .Sma-yun-one ul li {
		float: left;
		padding: 0 0.1rem;
		border-left: 1px solid #ccc;
	}
	
	#Sma-yun-footer .Sma-yun-one ul li a {
		color: #0000FF;
	}
	
	#Sma-yun-footer .Sma-yun-two {
		text-align: center;
		padding-top: 0.08rem;
	}
</style>